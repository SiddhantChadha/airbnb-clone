...
function Header({placeholder}) {
    ...
    const handleNoOfGuests = (e) => setNoOfGuests(e.target.value)
    ...
    return (
        <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10'>
            ...
            <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-sm'>
                ...
                <input type="text" placeholder={placeholder || 'Start your Search'} className='pl-5 bg-transparent outline-none flex-grow text-sm text-gray-600 placeholder-gray-400' value={searchInput} onChange={handleSearchInput}/>
                <SearchIcon className='hidden md:inline-flex h-8 bg-red-400 text-white rounded-full p-2 cursor-pointer md:mx-2' onClick={search}></SearchIcon>
                
            </div>
            
            <div className='flex space-x-4 items-center justify-end text-gray-500'>

                <p className='hidden md:inline-flex cursor-pointer md:ml-3 hover:font-semibold'>Become a host</p>
            ...
            
            {
             searchInput && <div className='flex flex-col col-span-3 mx-auto'>
                 ...
                 <div className='flex items-center border-b mb-4'>
                     ...
                     <input  type='number'  className='w-12 pl-2 outline-none text-lg text-red-400' value={noOfGuest} onChange={handleNoOfGuests} min={1}/>
