  ...
  return (
    <div className='relative h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[700px] 2xl:h-[800px]'>
        ...
        <div className='absolute top-1/2 w-full text-center'>
            ...
            <button className='text-purple-500 bg-white px-10 py-4 rounded-full shadow-md font-bold my-3 hover:shadow-xl active:scale-90 transition transfrom duration-150 ease-out'>I'm flexible</button>
        </div>
